...
from visualization import generate_mermaid_er  # import your new function
...
# Step 5: ER Diagram with Mermaid rendering and a button toggle
if st.session_state.conn:
    mermaid_code = generate_mermaid_er(st.session_state.conn)

    st.title("Mermaid ER Diagram")
    ...
    st.header("ER Diagram (Mermaid)")
    # mermaid(mermaid_code)  # this renders the diagram visually in Streamlit
